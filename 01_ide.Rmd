...
`r emo::ji("smile")` Pro tip: type a couple of letters then cmd+up for visual of matches or just up for last command
...
`r emo::ji("smile")` Pro tip: great for Shiny apps when you have ui, sever, and css files
...
-   Revert, will revert file back to last commit  
